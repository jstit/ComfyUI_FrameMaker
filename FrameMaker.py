    ...
    def INPUT_TYPES(cls):
        return {
            'required': {
                ...
                'x_pos_start': ('FLOAT', {'default': 0, 'min': -10000, 'max': 10000}),
                'x_pos_end': ('FLOAT', {'default': 0, 'min': -10000, 'max': 10000}),
                'y_pos_start': ('FLOAT', {'default': 0, 'min': -10000, 'max': 10000}),
                'y_pos_end': ('FLOAT', {'default': 0, 'min': -10000, 'max': 10000}),
